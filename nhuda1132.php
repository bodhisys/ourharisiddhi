...
<title>Our Harisiddhi - Harisiddhi - Events - Nhuda 1132</title>
<style type="text/css">
  ...
  <div class="mainContentWrapper">
    ...
    <div class="leftContent">
      ...
      <div class="innerContent">
        <h1>Nhu Dan 1132:</h1>
        <p>Our Harisiddhi - Nhu Dan 1132:</p>
        <h4>
<strong>"Vintuna: du vintuna !!!.. Nhu dan: 1132 ya vintuna" !!</strong>
 This years' nhu dan: festivity has been fixed on 10th Kartik. This time "36 youth club" will be organizing the 1132 nhu dan:'s parade, Harsiddhi. The procession expects everyone's participation. The participants can participate from their bhajan/music goups, clubs, certain community or even friend circles. The rally commences on the daybreak from the main temple area, Lachi, and after taking a one round tour of the village, will end in Lachi. All the participants will be served with samae bai on that day. Also, there will be a "bboying show" at lachi soon after the vintuna rally. New "harsiddhi b'boys" will perform their mind bulging moves on that day. Plus, Harsiddhi's first magazine based on the village: Daboo will be released on that date.
<br />
Since, the day represents the New Year according to Nepal Sambat, a lunar calendar created by and for newars, to keep it going all the newars should at least be a part of the celebration. 
</h4><br /><br />

          <div class="CB"></div>
          
          <!-- popular articles starts -->
          <div class="popularArticles">
            ...
            <div class="block">
              ...
              <div class="content" style="padding:10px;">
            	<a href="nhuda1132.php" class="otherArticles">Nhuda: 1132</a>
                <a href="daboo_magazine.php" class="otherArticles">Daboo Magazine</a>                
              </div>
              <!-- content ends -->
            </div>
            <!-- block ends -->
          </div>
          <!-- popular articles ends -->
      </div>
      <!-- inner content ends -->
