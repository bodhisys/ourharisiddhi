...
<title>Our Harisiddhi - Harisiddhi - Wallpapers</title>
<style type="text/css">
      ...
      <div class="innerContent">
        ...
        <div class="content galleryContent">
          ...
          <div class="block">
            <!-- title starts -->
            <div class="title">
              <a href="#">Glimpse of Our Harisiddhi</a>
            </div>
            <!-- title ends -->
            ...
            <div class="content">
              <ul class="gallLeft">
                <li><a href="12_year_harisiddhi_mela.php">12 Year Harisiddhi Mela</a></li>
                <li><a href="nhuda.php">Nepal Sambat 1132 Nhuda:</a></li>
                <li><a href="dashain.php">Dashain Festival 2068</a></li>
                <li><a href="#">Foolpati Festival 2068</a></li>
                <li><a href="#">Mini Football Tournament 2068</a></li>
                <li><a href="indrajatra.php">Indrajatra Festival 2068</a></li>
                <li><a href="#">PhotoShoot Program Day 3</a></li>
                <li><a href="#">PhotoShoot Program Day 2</a></li>
                <li><a href="#">PhotoShoot Program Day 1</a></li>
                <li><a href="#"><strong>View More</strong></a></li>
              </ul>
              <img src="http://www.ourharisiddhi.com/images/galleryImg.jpg" alt="" />
              <div class="CB"></div>
            </div>
            <!-- content ends -->
          </div>
          ...
          <div class="block">
            ...
            <div class="content">
              <ul class="gallLeft">
                <li><a href="#">ABCDEFGH Maharjan</a></li>
                <li><a href="#">ABCDEFGH Maharjan</a></li>
                <li><a href="#">ABCDEFGH Maharjan</a></li>
                <li><a href="#">ABCDEFGH Maharjan</a></li>
                <li><a href="#">ABCDEFGH Maharjan</a></li>
          ...
          <div class="block">
            ...
            <div class="content">
              <ul class="gallLeft">
                <li><a href="#">Gache, Chyasal with Kutumba</a></li>
                <li><a href="#">Cultural Tour to Mangalbazar</a></li>
                <li><a href="#">Harisiddhi, Lalipur</a></li>
                <li><a href="#">Sagarmatha Basecamp</a></li>
                <li><a href="#">Annapurna Basecamp</a></li>
                <li><a href="#">Mangalbazar, Lalitpur</a></li>
                <li><a href="#">Begnash Lake</a></li>
                <li><a href="#">Phewa Lake</a></li>
                <li><a href="#">Mountain Views from Pokhara</a></li>
                <li><a href="#"><strong>View More</strong></a></li>
              </ul>
              <img src="http://www.ourharisiddhi.com/images/galleryImg.jpg" alt="" />
              <div class="CB"></div>
