...
$contmsg = $_POST['contmsg'];
$today = date('Y-m-d');

if (eregi('http:', $contmsg)) { die ("Do NOT try that! ! "); }

if((!$contemail == "") && (!strstr($contemail,"@") || !strstr($contemail,".")))
{
$err =  "Enter Valid E-mail Address !\n";
}
/*if(($contname == "") && ($contname == "type your full name"))
{
$err .=  "Enter Your name !\n";
}
if(($contquestions == "") && ($contquestions == "Type your query..."))
{
$err .=  "Enter Feedback message !\n";
}
*/

if(empty($contname) || empty($contmsg) || empty($contemail)) {
$err = "Fields With an * Sign are Mandatory !\n";
}
if(empty($err))
{
	...
	$contmsg = stripcslashes($contmsg);
	
	$message = " $todayis [EST]\n
	From: $contname ($contemail)\n
	Address: $contadd\n
	Phone: $contemail\n
	Feedback: $contmsg\n
	...
	@mail("subodhmaharjan@gmail.com, info@ourharisiddhi.com", $subject, $message, $from);
	
	echo "<script lanaguage=\"javascript\">document.location.href=\"contact.php?sent=ok\";</script>";
}
...
<title>Our Harisiddhi - Harisiddhi - Contact Us</title>
<style type="text/css">
  ...
  <div class="mainContentWrapper">
    ...
    <div class="leftContent">
      ...
      <div class="innerContent">
        <h1>Contact Us</h1>
        <p>Our Harisiddhi - Contact Us</p>
        <h4>Please fill the form below and send us some feedbacks. Thank you!</h4>
        
        <!-- content starts -->
        <div class="content">
						<form action="<?= $_REQUEST['uri'];?>" method="post" id="contactform">
                         <?php
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td width="227"><span>Your Name <span>*</span> :</span></td>
                <td colspan="2" style="padding-bottom:6px;"><input class="txtField" value="<?= $contname?>" type="text" name="contname" id="contname" title="contname"/></td>
              </tr>
              <tr>
                <td height="38"><span>Address :</span></td>
                <td colspan="2"><input class="txtField" value="<?= $contadd?>" type="text" name="contadd" id="contadd" title="contadd" /></td>
              </tr>
              <tr>
                <td height="38"><span>Your Email <span>*</span> :</span></td>
                <td colspan="2"><input class="txtField" value="<?= $contemail?>" type="text" name="contemail" id="contemail" title="contemail" /></td>
              </tr>
              <tr>
                <td height="161"><span>Message <span>*</span> :</span></td>
                <td colspan="2" style="padding-top:7px;"><textarea cols="5" rows="5" class="txtareaStyle" type="text" name="contmsg" id="contmsg" title="contmsg"><?= $contmsg?></textarea></td>
              </tr>
              <tr>
                <td height="36">&nbsp;</td>
                <td width="87" style="padding-left:29px; padding-top:12px;">
                <input class="btnSubmit" value="Submit" id="Submit" name="aa" title="Click to contact us" type="submit" onclick="sendFeedback();">
                </td>
                <td width="365" style="color:#F00; padding-top:14px;"><?php if($_GET['sent']=="ok" && isset($_GET['sent'])){echo "Feedback Posted Successfully !";}
								else echo $err;?></td>
              </tr>  
            </table>                                        
            </form>
