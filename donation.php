...
<title>Our Harisiddhi - Harisiddhi - Donate Us</title>
<style type="text/css">
...
<div class="banner donation">
  <!-- wrapper starts -->
  <div class="wrapper donationWrapper">
  </div>
  <!-- wrapper ends -->
</div>
<!-- banner ends -->
  ...
  <div class="mainContentWrapper">
    ...
    <div class="leftContent">
      ...
      <div class="innerContent">
        <h1>Donation</h1>
        <p>Our Harisiddhi - Donation</p>
        <h4>You are welcome in our Donor Community. The amount that you are donating will be used for the better education of the child. You are then previleged to access the information regarding child's progress and the overall progress of ALL. After receiving your amount, we will send you a username and password to login in to the Sponsor's community and access the information and write comments to us. You can use PayPal or wire transfer method for transaction.  </h4>
        
        <!-- content starts -->
        <div class="content">
        <img src="http://www.ourharisiddhi.com/images/donation.jpg" alt="Make Donation" class="donationLeft" /><span class="FR">" Your support even your small amount goes a long way in Nepal become a leading social enterprise for sustainable development of Newari communities. Introducing and promoting sustainability concepts into "</span>

<div class="CB"></div>

<br />
Development Voyage envisions to become a leading social enterprise for sustainable development of Newari communities. Introducing and promoting sustainability concepts into Newari communities and market. Development of Newari communities. Introducing and promoting sustainability. Challenge towards sustainable development of Newari communities"
        </div>
        <!-- content ends -->
      </div>
      <!-- inner content ends -->
